...
export const skillsData: SkillItem[] = [
  ...
  { 
    ...
    icon: "🐘", 
    category: "languages",
    description: "Server-side scripting language for web development with object-oriented capabilities.",
...
export const skillGroups = {
  "webdev": {
    ...
    "Backend": ["nodejs", "php-backend"],
    "Database": ["postgresql", "mysql", "prisma"],
    "Others": ["selenium"]
  },
  "languages": ["php-lang", "typescript", "JavaScript", "html", "css", "Tailwind", "kotlin"],
  "tools": {
    "Project Management": ["github", "jira", "trello"],
    "Design": ["figma"],
    "Development Environments": ["vscode", "laragon", "xampp", "androidstudio"],
    "Database & API": ["docker", "sqlite", "firebase", "postman"]
  }
};